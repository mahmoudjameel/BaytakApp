...
export const ProfileScreen = () => {
  ...
  const menuItems: MenuItem[] = useMemo(
    () => [
      ...
      { id: '4', labelKey: 'profile.security', iconSource: require('../../assets/security-check.png'), iconBg: '#F0F0F0' },
      { id: '5', labelKey: 'profile.language', iconSource: require('../../assets/language-square.png'), iconBg: '#F0F0F0', onPress: () => navigation.navigate('LanguageSettings') },
      { id: '6', labelKey: 'profile.helpCenter', iconSource: require('../../assets/help-square.png'), iconBg: '#F0F0F0', onPress: () => navigation.navigate('HelpCenter') },
      { id: '7', labelKey: 'inviteFriends.menuLabel', iconSource: require('../../assets/user-multiple.png'), iconBg: '#F0F0F0' },
      { id: '8', labelKey: 'profile.signOut', iconSource: require('../../assets/favourite.png'), iconBg: '#FFF0F0', onPress: handleSignOut },
    ],
    [navigation],
  );
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.nameRow, rtl && styles.nameRowRtl]}>
          <Text style={[styles.name, rtl && styles.nameRtl]}>{displayName}</Text>
        ...
        <View style={styles.menuList}>
          {menuItems.map((item, index) => (
            ...
            >
              ...
              <Text style={[styles.menuLabel, rtl && styles.menuLabelRtl, item.id === '8' && styles.menuLabelDanger]}>{t(item.labelKey)}</Text>
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 88, height: 88, borderRadius: 44, backgroundColor: '#E8F4F3' },
  plusBadge: { position: 'absolute', bottom: 0, end: 0, width: 26, height: 26, borderRadius: 13, backgroundColor: Colors.primary, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#FFFFFF' },
  nameRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 },
  nameRowRtl: { flexDirection: 'row-reverse' },
  name: { fontSize: 20, fontFamily: FontFamily.outfit.bold, color: '#1B1D36' },
  nameRtl: { textAlign: 'right', writingDirection: 'rtl' },
  editBadge: { width: 26, height: 26, borderRadius: 6, backgroundColor: Colors.primary, alignItems: 'center', justifyContent: 'center' },
  email: { fontSize: 14, fontFamily: FontFamily.outfit.regular, color: '#9AA0AE', marginBottom: 24 },
  emailRtl: { textAlign: 'right', writingDirection: 'rtl' },
  ...
  menuIconImage: { width: 21, height: 21 },

    ...
    >
      ...
      >
        ...
        {loading ? (
          ...
          <Button title={t('auth.signIn')} onPress={handleSignIn} style={styles.signInBtn} />
        )}
...
const styles = StyleSheet.create({
  ...
  form: { marginBottom: 4 },
  fieldLabel: { fontSize: 16, lineHeight: 22, fontFamily: FontFamily.outfit.semiBold, color: '#1B1D36', marginBottom: 10, width: '100%' },
  fieldWrapper: { height: 54, borderRadius: 10, backgroundColor: '#F5F6FA', borderColor: '#F0F1F5', borderWidth: 1 },
  fieldInput: { fontSize: 14, fontFamily: FontFamily.outfit.regular, color: '#1E2239' },
  forgotBtn: { marginTop: 8, marginBottom: 20 },
  forgotBtnLtr: { alignSelf: 'flex-end' },
  forgotBtnRtl: { alignSelf: 'flex-start' },
  forgotText: { fontSize: 14, fontFamily: FontFamily.outfit.medium, color: '#1A7B6B' },
  signInBtn: { marginBottom: 24, height: 54, borderRadius: 12, backgroundColor: '#1A7B6B' },
  ...
  registerRow: { flexDirection: 'row', justifyContent: 'center', marginTop: 24, flexWrap: 'wrap', alignItems: 'center' },
  registerText: { fontSize: 14, fontFamily: FontFamily.outfit.regular, color: '#A7AEC1' },
  registerLink: { fontSize: 14, fontFamily: FontFamily.outfit.semiBold, color: '#1A7B6B' },
});
